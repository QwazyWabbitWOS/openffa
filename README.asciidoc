...
I merged the 3.20 xatrix code in and it compiles. But this is still a big todo as it comes out totally bugged.

Problems:
---------
- the xatrix weapons are non-functional, one a weapon is fired it stays in a loop forever
- health packs seem to be bugged aswell, the game somehow mixes them with the quadfire item and they don't have the expected effect
